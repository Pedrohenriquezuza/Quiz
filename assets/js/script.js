...
function finishQuiz(){
    ...
    if(points < 30){
        document.querySelector('.scoreText1').innerHTML = `Dá pra melhorar!`
        ...
        document.querySelector('.scoreText1').innerHTML = `Wow, Perfeito!`
        document.querySelector('.scorePct').style.color = '#0D630D'
    }

    // Porcentagem Final de acerto
    document.querySelector(".scorePct").innerHTML = `Acertou ${points}%`

    // Frase Final de acerto
